        ...
        <div class="container mx-auto px-4">
            <nav class="flex justify-between items-center">
                <RouterLink to="/home" class="text-xl font-bold">
                    <svg class="w-32 md:w-64 mx-auto" viewBox="0 0 210 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                        ...
                        ></path>
                        <path
                            d="M193.377 23.1363H180.143V16.4644C180.143 12.023 177.668 10.7931 173.467 10.6729V29.4991H199.454C199.327 25.4956 198.037 23.1363 193.377 23.1363Z"
                            fill="#FFBE00"
                        ></path>
                        <path
                ...
                <ul class="relative flex flex-row items-center">
                    ...
                    <li class="ml-2">
                        <span @click="handleLogout" class="p-2 hover:text-gray-300"><i class="fa fa-sign-out"></i></span>
                    </li>
                </ul>
            </nav>
        </div>
